...
rnb = rnb_emp    # Growth rate for non-breeding period (emp. -0.0568)
...
df_ews.loc[:20].to_csv('data_export/trans_rb/'+dir_name+'/ews_singles.csv')

# Export power spectra
df_pspec.loc[:20].to_csv('data_export/trans_rb/'+dir_name+'/pspec.csv')

# Export aggregates
df_ews_means.to_csv('data_export/trans_rb/'+dir_name+'/ews_means.csv')
df_ews_deviations.to_csv('data_export/trans_rb/'+dir_name+'/ews_deviations.csv')

# Export Kendall tau values
df_ktau.to_csv('data_export/trans_rb/'+dir_name+'/ktau.csv')
