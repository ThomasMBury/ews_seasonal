...
bif_data_x = simulate(model=ricker_b, num_gens=100, rate_min=0.1, rate_max=70, num_rates=1000, num_discard=100)

# knb values
knb_vals = bif_data_x.columns
...
bif_data_y = x_to_y(bif_data_x, knb_vals)    


# Make plot of bifurcation
bifurcation_plot(bif_data_x, title='Ricker Bifurcation Diagram', xmin=0, xmax=70, ymin=0, ymax=200, save=False)
bifurcation_plot(bif_data_y, title='Ricker Bifurcation Diagram', xmin=0, xmax=70, ymin=0, ymax=200, save=False)


# Export bifurcation points
bif_data_x.to_csv('../data_export/bif_data/bif_knb_x.csv')
bif_data_y.to_csv('../data_export/bif_data/bif_knb_y.csv')
